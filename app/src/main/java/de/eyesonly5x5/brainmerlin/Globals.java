...
// /data/user/0/de.eyesonly5x5.brainmerlin/files/Solitar.txt
 ...
 */
    ...
    public void setGameData( String txt ) {
        ...
        if( txt == "Memory" ) {
            ...
            for (int i = 1; i <= 12; i++) {
                MemoryPics.add(myContext.getResources().getIdentifier(dat + StrZ(i, 2), "drawable", "de.eyesonly5x5.brainmerlin"));
            }
        } else {
            Anzahl = 4;
            ...
            for (int i = 1; i <= Anzahl; i++) {
                for (int j = 1; j <= Anzahl; j++) {
                    // Log.d( "DingsDA:", "i:"+i+":j:"+j+":NG:"+dat +"_"+ i +"_"+ j + ":vB:"+ (((i-1)*Anzahl)+j) +":id:"+ myContext.getResources().getIdentifier("i"+ (((i-1)*Anzahl)+j), "id", "de.eyesonly5x5.brainmerlin") );
                    MemoryPics.add(myContext.getResources().getIdentifier(dat +"_"+ i +"_"+ j, "drawable", "de.eyesonly5x5.brainmerlin"));
                    // viewButIDs.add(  myContext.getResources().getIdentifier("i"+ (((i-1)*Anzahl)+j), "id", "de.eyesonly5x5.brainmerlin"));
                }
            }
        }
